...
-   `📁 FIGURES/`: Contains all the output plots and figures generated by the analysis scripts in PDF and PNG format, organised by virus type.
-   `📁 scripts/`: Contains the analysis scripts used to process data and generate the figures.
-   `📁 FASTA_FILES/`: Contains the GTPV and SPPV FASTA files used for sequence analysis.
-   `📁 XG_FILES/`: Contains the GTPV and SPPV XG files used for conversion to PG format.
-   `📁 PG_FILES/`: Contains the GTPV and SPPV PG files used for visualisation with sequenceTubeMap.
