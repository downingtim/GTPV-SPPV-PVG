...
#mafft --auto pangrowth/communities.genomes.fasta > aligned_communities.fasta
...
def create_sliding_window_plot(sequences, region_name, start, end, reference_id='NC_004002.1'):
    ...
    plt.xlabel('NC_004002.1 Coordinates (bp)', fontsize=12)
...
def create_pairwise_matrix(sequences, region_name, start, end, reference_id='NC_004002.1'):
...
def main():
    ...
    parser.add_argument("--reference", "-r",
                        default="NC_004002.1",
                        help="Reference sequence ID for coordinates (default: NC_004002.1)")
